...
<div class="headerwrapper">
    <div id="header" class="container">
        <div class="logo"><a href="#"><img src="resources/images/LOGO.png" alt="logo" width="165" height="74"></a></div>
        <!--end of Logo-->
        <nav>
            <ul id="navigations">
                ...
                <c:if test="${pageContext.request.userPrincipal.name != null}">
                    <li><a href="http://interfaceusuariospedidos.herokuapp.com/conta.jsp">MINHA CONTA</a></li>
                </c:if>
            </ul>
        </nav>
    </div> <!--end of header-->
            ...
            <ul class="slides">
                ...
                <li class="slide">
                    <div ng-repeat="p in produtos">
                        <div class="item">
                            <img src="resources/{{p.imageStr}}" width="100" height="100" alt="sliderimg"
                                 class="wow flipInX"
                                 data-wow-delay=".8s">
...
<%--<a href="https://www.facebook.com/jean412"><img src="resources/images/facebook.png" width="20" height="20"--%>
<%--alt="fb"> </a>--%>
<%--<a href="https://www.facebook.com/jean412"><img src="resources/images/behance.png" width="20" height="20"--%>
<%--alt="behance"> </a>--%>
...
<div class="fixedsocial">
    <a href="https://www.facebook.com/jean412"><img src="resources/images/facebook.png" width="20" height="20" alt="fb">
    </a>
    <a href="https://www.facebook.com/jean412"><img src="resources/images/behance.png" width="20" height="20"
                                                    alt="behance"> </a>
