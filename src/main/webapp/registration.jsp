    ...
    <body>
        ...
        <div class="bookonlinewrapper">
            ...
            <form:form method="POST" modelAttribute="userForm" class="form-signin">
                <h3 class="wow fadeInUp" data-wow-delay="0.3s"> CRIE SUA CONTA AGORA</h3>
                <spring:bind path="username">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <form:input type="text" path="username" class="name wow zoomIn" placeholder="Username"
                ...
                <spring:bind path="password">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <form:input type="password" path="password" class="name wow zoomIn" placeholder="Password"></form:input>
                ...
                <spring:bind path="passwordConfirm">
                    <div class="form-group ${status.error ? 'has-error' : ''}">
                        <form:input type="password" path="passwordConfirm" class="name wow zoomIn"
                                    placeholder="Confirm your password"></form:input>
                        <form:errors path="passwordConfirm"></form:errors>
                        </div>
                </spring:bind>

                <button class="booknow wow fadeInUp" type="submit">Criar</button>
            </form:form>
